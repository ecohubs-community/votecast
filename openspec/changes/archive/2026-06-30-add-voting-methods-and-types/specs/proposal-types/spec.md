...
> Note: The exact boundary of what a TypeVersion freezes vs. community-level wiring is provisional
> until Task 2 (data model) resolves; see `design.md` D4 and `deferred.md` §3.
