// Originally generated by better-auth CLI, now manually maintained.
// Do NOT re-run `pnpm auth:schema` without backing up this file first.
import { relations, sql } from 'drizzle-orm';
import { sqliteTable, text, integer, index } from 'drizzle-orm/sqlite-core';

// Shared timestamp default (milliseconds)
